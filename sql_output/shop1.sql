...
CREATE TABLE `goods` (
  ...
  `goods_img` varchar(20) NOT NULL,
  `origin_price` int(10) NOT NULL,
  `current_price` int(10) NOT NULL,
  `shelf_time` varchar(15) NOT NULL,
  `goods_state` int(2) NOT NULL,
...
-- Dump completed on 2019-10-08 16:33:33
